...
##### if __name__ == "__main__": # Проверяем, является ли программа main программой - это означает, что мы запускаем этот файл из командной строки (т.е. из командной строки программа запускается)
user_list = []
